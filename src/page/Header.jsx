...
const Header = () => {
  ...
  return (
    <>
      <div className="absolute top-5 left-4 z-50 md:hidden">
        <div onClick={() => setCheckMenu(!checkMenu)}>
          {checkMenu ? (
            ...
            <RiMenu2Line size={30} className="text-sky-800" />
          )}
        </div>
      </div>
      ...
      >
        {/* Sidebar layout with spacing between top content and logout */}
        <div className="flex flex-col justify-between h-full">
            ...
            <nav className="flex flex-col gap-4 w-full">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  ...
                  ${
                    isActive
                      ? "bg-[#ffffff3a] rounded shadow text-purple-600"
                      : "hover:bg-white/10"
                  } text-white`
                }
              >
          ...
          <button
            ...
            className="mt-6 flex items-center gap-3 px-4 py-2 rounded-md bg-sky-900/90 hover:bg-blue-900 transition-all duration-200 text-white"
          >
