    ...
    <div className="flex  flex-col w-full h-[100%] bg-white max-[800px]:py-15 ">
      <header className=" z-10 w-full max-[800px]:flex h-[12vh] bg-sky-800 max-[800px]:bg-white shadow-xl px-5 py-4 flex   items-center justify-between gap-4 ">
        ...
        <div className="relative w-full max-w-xs">
          ...
          />
          <IoSearchOutline className="absolute right-3 top-1/2 transform text-white -translate-y-1/2 text-black" />
        </div>
      </header>
      ...
      <section className="flex flex-wrap  gap-6 px-4 py-10">
        {dataCards.map((card, i) => (
          <div
            key={i}
            className={`w-full sm:w-[300px] md:h-[300px] md:w-[350px] lg:w-[400px] p-6 rounded-2xl text-white bg-gradient-to-br ${card.color} shadow-xl hover:scale-105 transition-transform duration-300`}
          >
