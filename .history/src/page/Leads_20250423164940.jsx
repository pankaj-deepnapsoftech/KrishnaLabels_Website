...
const Leads = () => {
  ...
  return (
    <div className="w-full md:w-full h-full bg-gray-200 rounded-e-2xl shadow-xl p-4 max-[800px]:pt-15">
      <h2 className="text-xl font-bold text-center text-gray-700 mb-4">LEADS DATA</h2>
      <div className="rounded-[10px] w-full md:w-full">
