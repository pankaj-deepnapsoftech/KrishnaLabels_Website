...
export default function Dashboard() {
  return (
    <div className="flex   h-full bg-[#fcfcfc] w-full">
      {/* Main Content */}
      <main className="flex-1 h-full p-15">
        ...
        {/* Cards */}
        <div className="flex flex-wrap  gap-6  mb-10 h-[300px] ">
          {dataCards.map((card, i) => (
            <div
              key={i}
              className={`p-6 w-[300px] h-[300px] text-white rounded-xl bg-gradient-to-r ${card.color} max-[800px]:h-full`}
            >
