...
export default function Dashboard() {
  return (
    <div className="flex relative flex-col w-full h-[100%] bg-white ">
      <header className="sticky top-0 z-10 w-full bg-sky-800 max-[800px]:bg-white shadow-xl flex gap-5 py-4 max-[800px]:py-8">
        <div className="w-50 relative left-5 flex justify-center items-center gap-2 rounded-[10px] content-center font-bold">
          ...
          <span className="md:hidden max-[800px]:block font-[800] text-sky- text-xl">
            Dashboard
          </span>
        </div>
