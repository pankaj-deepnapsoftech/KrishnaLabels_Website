...
export default function Dashboard() {
  return (
    <div className="flex h-full bg-[#fcfcfc] w-full ">
      {/* Main Content */}
      <main className="flex-1 h-full pt-15 p-4 md:p-8 lg:p-12">
        {/* Header */}
        <header className="flex  sm:flex-row justify-between items-center w-[80%] m-auto sm:items-center mb-8 gap-4">
          ...
          <div className="relative w-full sm:w-[12rem]">
            <input
              type="text"
              placeholder="Search..."
              className="px-3 py-2 pr-10 border-b focus:outline-none w-[12REM]"
            />
