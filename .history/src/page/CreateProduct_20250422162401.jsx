...
const CreateProduct = () => {
  ...
  return (
    <div className=" w-full flex h-full justify-center bg-gray-200 px-10 py-10">
      <div className="w-full max-w-2xl h-[70%] bg-white shadow-lg rounded-lg p-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-6 text-center">
          CREATE PRODUCT
        </h2>

        <form onSubmit={handleSubmit} className="space-y-6 h-[80%]">
          {/* Product Name */}
          <div>
          ...
          <div className="mb-6">
            ...
            <label
              ...
              className="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-md cursor-pointer hover:border-sky-800 hover:bg-gray-50 transition duration-300"
            >
