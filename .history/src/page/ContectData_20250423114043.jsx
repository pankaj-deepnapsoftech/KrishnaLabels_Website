      ...
      >
        ...
        <div>
          ...
          <input
            ...
            required
            className="mt-1 w-full   border-b py-3 focus:outline-none "
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            required
            className="mt-1 w-full py-3  border-b  focus:outline-none "
          />
        </div>
        ...
        <motion.button
          type="submit"
          className="w-full py-3 bg-sky-800 text-white font-semibold rounded-lg hover:bg-sky-700 transition focus:outline-none focus-visible:outline-none"
          whileTap={{ scale: 0.9 }}
        >
          Submit
        </motion.button>
