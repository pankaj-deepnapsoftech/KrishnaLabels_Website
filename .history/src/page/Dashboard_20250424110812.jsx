    ...
    <div className="flex  flex-col w-full h-[100%] bg-white max-[800px]:py-15 ">
      <header className=" z-10 w-full h-[12vh] bg-sky-800 max-[800px]:bg-white shadow-xl px-5 py-4 flex flex-col md:flex-row items-center justify-between gap-4 ">
        <div className="w-50 flex justify-center items-center gap-2 text-white rounded-[10px]  content-center md:text-2xl font-bold">
          <MdDashboardCustomize className="md:hidden max-[] text-[30px]  text-white mx-[800px]:text-sky-800" />
          <span className="md:hidden max-[] text-white text-[30px] font-[800] mx-[800px]:text-sky-800">Dashboard</span>
        </div>
