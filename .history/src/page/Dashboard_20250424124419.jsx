...
export default function Dashboard() {
  return (
    <div className="flex  flex-col w-full h-[100%] bg-white  ">
      <header className=" z-10 w-full max-[800px]:flex h-[12vh] bg-sky-800 md:bg-white shadow-xl px-5 py-4 flex   items-center justify-between gap-4 ">
        <div className="w-full flex justify-start items-center gap-2 py-2 rounded-[10px]  font-bold">
          <MdDashboardCustomize className="text-[30px] text-sky-800 md:text-sky-800" />
          <span className="font-[500] text-sky-800 md:text-white   text-2xl ">Dashboard</span>
        </div>
      </header>
