...
const Contact2 = () => {
  ...
  return (
    <div className="flex justify-center w-full h-full items-center max-[800px]:h-[70%] bg-gray-200 p-4">
      <form
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            required
            className="mt-1 w-full   border-b py- focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
