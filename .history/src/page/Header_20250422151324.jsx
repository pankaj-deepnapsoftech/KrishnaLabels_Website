...
const Header = () => {
  ...
  `}
    ...
    ${isActive ? "bg-[#ffffff65] font-bold shadow text-white" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-2 rounded-md transition-all duration-200 
    ${isActive ? "bg-white font-bold shadow text-white" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
