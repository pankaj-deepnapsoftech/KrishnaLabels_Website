...
export default function Dashboard() {
  return (
    <div className="flex overflow-auto  h-[100%] bg-gray-100 w-full">
      {/* Main Content */}
      <main className="flex-1 h-[100%] p-15">
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="relative w-[12rem]">
            <input
              type="text"
              placeholder="Search..."
              className="px-3 py-1 pr-10 border-b focus:outline-n w-full"
            />
        ...
        <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
          <RiDashboardLine className="text-cyan-600" /> Dashboard
        </h2>
