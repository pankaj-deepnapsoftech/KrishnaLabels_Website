...
export default function Dashboard() {
  return (
    <div className="flex  flex-col w-full h-[100%] bg-white  ">
      <header className=" z-10 w-full text-center max-[800px]:flex h-[8vh] bg-white shadow-xl px-5  flex   items-center justify-between gap-4 ">
        <div className="w-full flex justify-end md:justify-start items-center gap-2 py-2 rounded-[10px]  font-bold">
          <MdDashboardCustomize className="text-[30px] text-sky-800" />
          <span className="md:font-[900] text-sky-800 text-center  text-2xl ">Dashboard</span>
        </div>
      </header>
