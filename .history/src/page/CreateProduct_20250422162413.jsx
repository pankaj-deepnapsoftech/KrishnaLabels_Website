        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mb-6">
            ...
            <label
              ...
              className="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-md cursor-pointer hover:border-sky hover:bg-gray-50 transition duration-300"
            >
