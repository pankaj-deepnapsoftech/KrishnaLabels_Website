...
const Header = () => {
  ...
  `}
     ...
     ${isActive ? "bg-white font-bold shadow" : "hover:bg-white/10"} text-white`
          ...
          >
            <RiDashboardLine className="text-xl text-blue-600" />
     ...
     ${isActive ? "bg-[#fff] font-bold shadow" : "hover:bg-white/10"} text-white`
          ...
          >
            ...
            <span className="text-BLU">Leets</span>
          </NavLink>
     ...
     ${isActive ? "bg-[#fff] font-bold shadow" : "hover:bg-white/10"} text-white`
          ...
          >
            ...
            <span className="text-BLU">Contact</span>
          </NavLink>
          <NavLink
            to="/createproduct"
            className={({ isActive }) =>
     ...
     ${isActive ? "bg-[#fff] font-bold shadow" : "hover:bg-white/10"} text-white`
          ...
          >
            ...
            <span className="text-BLU">Create Product</span>
          </NavLink>
          <NavLink
            to="/producttable"
            className={({ isActive }) =>
