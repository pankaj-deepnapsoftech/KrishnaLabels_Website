...
const Header = () => {
  ...
  `}
    ...
    ${isActive ? "bg-[#ffffff3a] ro shadow text-white" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-2 rounded-md transition-all duration-200 
    ${isActive ? "bg-[#ffffff3a]  shadow text-white" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-2 rounded-md transition-all duration-200 
    ${isActive ? "bg-[#ffffff3a]  shadow texwhite" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-2 rounded-md transition-all duration-200 
    ${isActive ? "bg-[#ffffff3a]  shadow text-purple-600" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
