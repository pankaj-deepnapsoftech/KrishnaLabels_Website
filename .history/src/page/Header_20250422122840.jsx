...
const Header = () => {
  ...
  `}
     ...
     ${isActive ? "bg-blue-800 font-bold shadow" : "hover:bg-white/10"} text-white`
            }
          >
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4  py-2 rounded-md transition-all duration-200 
     ${isActive ? "bg-blue-600 font-bold shadow" : "hover:bg-white/10"} text-white`
            }
          >
            <RiAppsLine className="text-xl text-white" />
            <span className="text-white">Leets</span>
          </NavLink>
