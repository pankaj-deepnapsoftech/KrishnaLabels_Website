...
export default function Dashboard() {
  return (
    <div className="flex  flex-col w-full h-[100%] bg-white  ">
      <header className=" z-10 w-full max-[800px]:flex h-[12vh] bg-sky-800 max-[800px]:bg-white shadow-xl px-5 py-4 flex   items-center max-[800pxjustify-between gap-4 ">
        <div className="w-50 flex justify-center items-center gap-2 relative left-4 rounded-[10px]  content-center md:text-2xl font-bold">
