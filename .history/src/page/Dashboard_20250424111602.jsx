...
export default function Dashboard() {
  return (
    <div className="flex  flex-col w-full h-[100%] bg-white max-[800px]:py-15 ">
      <header className=" z-10 w-full max-[800px] h-[12vh] bg-sky-800 max-[800px]:bg-white shadow-xl px-5 py-4 flex flex-col md:flex-row items-center justify-between gap-4 ">
        <div className="w-50 flex justify-center items-center gap-2  rounded-[10px]  content-center md:text-2xl font-bold">
          ...
          <span className="md:hidden max-[800px]:block  text-[30px] font-[800] mx-[800px]:text-sky-800 underline underline-offset-8">Dashboard</span>
        </div>
