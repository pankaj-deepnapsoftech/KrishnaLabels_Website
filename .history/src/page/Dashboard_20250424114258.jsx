...
export default function Dashboard() {
  return (
    <div className="flex rela flex-col w-full h-[100%] bg-white ">
      <header className=" z-10 w-full h-[20vh] pt-5  md:h-[12vh] bg-sky-800 max-[800px]:bg-white shadow-xl  md:py-4 flex  gap-5 ">
        <div className="w-50 relative left-5 flex justify-center items-center gap-2  rounded-[10px]  content-center md:text-2xl font-bold">
        ...
        <div className="relative w-[40%] left-5">
          <input
            type="text"
            placeholder="Search..."
            className="w-full  border-b  text-white  focus:outline-none  max-[800px]:text-black "
          />
