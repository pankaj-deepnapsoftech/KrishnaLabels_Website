...
const ProductTable = () => {
  return (
    <div className="w-full  mx-auto h-full px-8 max-[800px]:py-10  max-[800px]:px-2 ">
          ...
          {products.map((product, index) => (
            ...
            >
              <td className="py-4 px-4 flex items-center gap-4">
                ...
                />
                <span className="font-medium  max-[800px]:text-[12px] text-gray-800">{product.name}</span>
              </td>
              <td className="py-4 px-4 text-gray-600 text-sm  max-[800px]:text-[12px]">{product.description}</td>
