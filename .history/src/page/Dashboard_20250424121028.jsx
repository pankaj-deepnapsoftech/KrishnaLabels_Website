  ...
  return (
    <div className="flex  flex-col w-full h-[100%] bg-white  ">
      <header className=" z-10 w-full max-[800px]:flex h-[12vh] bg-sky-800 max-[800px]:bg-white shadow-xl px-5 py-4 flex   items-center justify-between gap-4 ">
        <div className="w-50 flex justify-end items-center gap-2 relative left-4 rounded-[10px]  content-center md:text-2xl font-bold">
          <MdDashboardCustomize className="md:hidden max-[800px]:block text-[30px] mx-[800px]:text-sky-800" />
          <span className=" md:text-[30px] font-[800] mx-[800px]:text-sky-800   text-xl ">Dashboard</span>
        </div>
        <div className="relative w-[35%] invisible md:block">
          <input
            type="text"
            placeholder="Search..."
