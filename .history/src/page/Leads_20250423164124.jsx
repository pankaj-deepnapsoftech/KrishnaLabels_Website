...
const Leads = () => {
  ...
  return (
    <d                                        iv className="w-full md:w-full h-full bg-gray-200  shadow-xl p-4 max-[800px]:pt-15 ">
      <h2 className="text-xl font-bold text-center text-gray-700 mb-4">CONTACT DATA</h2>
      <div className=" rounded-xl md:w-full">
        <table className="w-full text-left border-collapse md:w-[60%]">
          <thead>
