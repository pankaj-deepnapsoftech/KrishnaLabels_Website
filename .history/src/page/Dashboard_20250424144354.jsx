    ...
    <div className="flex  flex-col w-full h-[100%] bg-white  ">
      <header className=" z-10 w-full max-[800px]:flex h-[8vh] bg-white shadow-xl px-5  flex   items-center justify-between gap-4 ">
        <div className="w-full flex justify-end md:justify-center items-center gap-2 py-2 rounded-[10px]  font-bold">
          ...
          <span className="md:font-[1000] text-sky-800  md:text-3xl text-2xl underline underline-offset-8 ">Dashboard</span>
        </div>
      </header>

      {/* Cards Section */}
      <section className="flex flex-wrap max-[800px]:items-center gap-6 px-4 py-10">
        {dataCards.map((card, i) => (
          <div
            key={i}
            className={`w-[350px]   md:h-[300px] md:w-[350px] h-[200px]  p-6 rounded-2xl text-white bg-gradient-to-br ${card.color} shadow-xl hover:scale-105 transition-transform duration-300`}
          >
