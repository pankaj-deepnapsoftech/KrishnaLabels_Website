...
const CreateProduct = () => {
  ...
  return (
    <div className="w-full  flex  h-[100%] justify-center  bg-gray-100 px-2  max-[800px]">
      <div className="w-full max-w-[700px] mt-10 h-[80%] bg-white shadow-md rounded-lg  p-6 pt-10">
