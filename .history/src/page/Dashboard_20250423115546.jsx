  ...
  return (
    <div className="flex flex-col w-full h-[100%] bg-white max-[800px]:py-15 ">
      ...
      <header className=" z-10  h-[12vh] shadow-xl px-5 py-4 flex flex-col md:flex-row items-center justify-between gap-4 ">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, unde. At asperiores provident, nam dolor laborum nihil impedit nesciunt similique ratione optio consequuntur aperiam quae rerum excepturi vero corporis exercitationem?</p>
