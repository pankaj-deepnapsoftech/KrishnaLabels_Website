        ...
        <thead className="bg-gray-50 w-full text-gray-600 text-sm font-medium">
          <tr>
            ...
            <th className="px-4 py-3 text-left flex items-center gap-1">
              Company
              <svg className="w-3 h-3 text-sky-800" fill="currentColor" viewBox="0 0 20 20">
            ...
            <tr key={idx} className="border-b hover:bg-gray-50 transition">
              ...
              <td className="px-4 py-2 space-x-1">
                {row.tags.map((tag, i) => (
                  <button
                    key={i}
                    className=" bg-sky-800  text-white text-xs px-2 py-2 mb-1 rounded-full hover:bg-blue-600"
                  >
                    {tag}
                  </button>
                ))}
