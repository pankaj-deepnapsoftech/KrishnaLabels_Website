      ...
      >
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            required
            className="mt-1 w-full p-3 border-b  focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            required
            className="mt-1 w-full p-3 border- focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
