...
const Header = () => {
  ...
  `}
    ...
    ${isActive ? "bg-[#ffffff3a] font-bold shadow text-white" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
    ...
    ${isActive ? "bg-[#ffffff3a] font-bold shadow text-white" : "hover:bg-white/10 text-white"}`
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-2 rounded-md transition-all duration-200 
    ${isActive ? "bg-[#ffffff3a] font-bold shadow texwhite" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-2 rounded-md transition-all duration-200 
    ${isActive ? "bg-[#ffffff3a] font-bold shadow text-purple-600" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-2 rounded-md transition-all duration-200 
    ${isActive ? "bg-white font-bold shadow texwhite" : "hover:bg-white/10 text-white"}`
            }
          >
            {({ isActive }) => (
              <>
                <FaTableList className={`text-xl ${isActive ? "text-purple-600" : "text-white"}`} />
                <span className={isActive ? "texwhite" : "text-white"}>Product Table</span>
              </>
            )}
          </NavLink>
