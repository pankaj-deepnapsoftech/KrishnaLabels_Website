...
export default function Dashboard() {
  return (
    <div className="flex flex-col w-full h-[100%] bg-white max-[800px]:py-15 ">
      {/* Header */}
      <header className=" z-10  h-[12vh] bg-gray-50 shadow-xl px-5 py-4 flex flex-col md:flex-row items-center justify-between gap-4 ">
        <h2 className="text-2xl bg-sky-800 text-white rounded h-12 w-50 md:text-2xl font-bold text-gray-800">
          Dashboard
        </h2>
