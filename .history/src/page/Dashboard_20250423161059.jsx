  ...
  return (
    <div className="flex flex-col w-full h-[100%] bg-white max-[800px]:py-15 ">
      ...
      <header className=" z-10 w-full h-[12vh] bg-gray-50 shadow-xl px-5 py-4 flex flex-col md:flex-row items-center justify-between gap-4 ">
        <h2 className="text-2xl bg-sky-800 w-45 text-center text-white rounded h-14  content-center md:text-2xl font-bold text-gray-800">
          Dashboard
        </h2>
        <div className="relative w-full max-w-xs">
          <input
            type="text"
            placeholder="Search..."
            className="w-full pl-4 pr-10 py-2  border-2 rounded-2xl border border-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400"
          />
