...
export default function Dashboard() {
  return (
    <div className="flex  flex-col w-full h-[100%] bg-white ">
      <header className=" z-10 w-full h-[60%] pt-5  md:h-[12vh] bg-sky-800 max-[800px]:bg-white shadow-xl  md:py-4 flex  gap-5 ">
        <div className="w-50 flex justify-center items-center gap-2  rounded-[10px]  content-center md:text-2xl font-bold">
          ...
          <span className="md:hidden max-[800px]:block  md:text-[30px] font-[800] mx-[800px]:text-sky-800 relative left-20  text-xl ">Dashboard</span>
        </div>
