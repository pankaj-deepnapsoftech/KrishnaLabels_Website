...
const CreateProduct = () => {
  ...
  return (
    <div className=" w-full flex h-full items-center justify-center bg-gray-200 px-10 py-10">
      <div className="w-full max-w-2xl h-[50%] bg-white shadow-lg rounded-lg p-8">
