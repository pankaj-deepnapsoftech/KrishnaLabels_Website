...
export default function Dashboard() {
  return (
    <div className="flex  flex-col w-full h-[100%] bg-white  ">
      <header className=" z-10 w-full max-[800px]:flex h-[12vh] bg-sky-800  shadow-xl px-5 py-4 flex   items-center justify-between gap-4 ">
        <div className="w-full flex justify-end items-center gap-2 py-2 rounded-[10px]  font-bold">
          <MdDashboardCustomize className="text-[30px]  md:hidden max-[800px]:block text-white" />
          <span className="  md:hidden max-[800px]:block  font-[500] text-white   text-2xl ">Dashboard</span>
        </div>
        <div className="relative w-[35%] hidden md:block">
          ...
          />
          <IoSearchOutline className="absolute right-3 top-1/2 transform md:text-white text-black -translate-y-1/2 text-black" />
        </div>
      </header>
