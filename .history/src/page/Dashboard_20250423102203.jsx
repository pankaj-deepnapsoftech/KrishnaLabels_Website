...
export default function Dashboard() {
  return (
    <div className="flex flex-col w-full h-full bg-gray-200 max-[800px]:py-15 ">
      {/* Header */}
      <header className=" z-10 px bg-[#ffff] h-[12vh] shadow-md px-5 py-4 flex flex-col md:flex-row items-center justify-between gap-4 ">
