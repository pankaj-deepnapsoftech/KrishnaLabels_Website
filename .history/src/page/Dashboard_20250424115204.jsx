...
export default function Dashboard() {
  return (
    <div className="flex relative flex-col w-full h-[100%] bg-white ">
      <header className="sticky top-0 z-10 w-full bg-sky-800 max-[800px]:bg-white shadow-xl flex md:justify-center gap-5 py-8 max-[800px]:py-8">
        ...
        <div className="relative w-[30%] left-4">
          <input
            type="text"
            placeholder="Search..."
